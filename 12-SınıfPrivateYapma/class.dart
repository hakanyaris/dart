...
//moneyType rakam olarak atanırsa    satırdaki
    ...
    user2.updateMoneyWithNumber(15);
  }

  final _newType = user.moneyType is String
      ? user.moneyType as String
      : ''; //moneyType string ie moneyType String  değerini ata
//moneytype strig değilse '' boş string değeri ata.
  print((_newType as String) + 'A');
  print((user2.moneyType as String) +
      '  A'); //burada as yazarak moneyType Kesinlikle string tipinde gelecek diyorum .
