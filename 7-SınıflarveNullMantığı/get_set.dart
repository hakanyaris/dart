...
int _money;// KAPSULE ETMEK yani  propertiesi çağrılırken ve değer atanırken kontola altında tutmak
  ...
  set money(int? money) {//değer atanırken 1. yöntem
    /*if(money==null){
    ...
    _money = money;*/
    //2. yöntem
    _money =money==null ? 0:money;//burda _money=money e eşitliyor ama money == null işe  _money 0 yap değise _money i moneye eşitle. 
