...
//typedef  yani  tanımlı  bi fonksiyonu v.b durumu yeniden isimlendirmedir  takma isim takma duruöudur. bu sayede  kullnım
//kolaylığı olur.
...
//fonksiyon içined parametre olarak fonksiyon istedik
  void calculateMoney(void Function(int data) onComplate) {
    ...
    money += 5;
    onComplate(
        money); //Oncomplate fonksiyonuna money i gönderiyoruz.main de çalışacak calculateMoney fonksiyonuna  moneyi gönderiyoruz
  }
}
