//SENKRON: Program içerisinde bir işlem yapılırken, bu işlem bitmeden ikinci bir işleme geçilemez.
// Bu yapıya Senkron denir.
...
//await metoduna sıra gelince  aşağı koda geçirmez 6 sn bekletir ve  kendisi çalıştıktan sonra aşağıdaki kodalara izin verir.
  await Future.delayed(Duration(seconds: 6)).whenComplete(() => {
        print('await ')
      }); //başına await koyduktan sonra void metodumuz da Future ve async eklemliyiz.
  print('son');
  print('enson');
}
