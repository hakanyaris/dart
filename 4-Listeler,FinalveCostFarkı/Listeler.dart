...
//Dinamik uzunlukta, büyüyebilen, küçülebilen liste tanımı
  ...
  // Liste ve objelerde(class) final kulanırsak listenin kendisine(özüne ) dokunamayız ama içindeki nesnelere
  //dokunabiliriz.ekleme çıkarma silme
  final List <int> moneys2=[100,200,300,150,50];
  moneys2.add(95);
  
  // const ta ise listeninin  ve sınıfın (class) hiçbir elemanına ve özüne dokunamayız. ekleme silme  
  //v.b. yapılmaz
  ...
  //growable varsayıla olarak false olur tanımlamasakta olur.
   ...
   print(ornekListe);// çıktı[0,0,0]     bütün elemanlara varsayılan olarak sıfır atadık.
   ornekListe[2]=4;
   print(ornekListe[2]);
  }